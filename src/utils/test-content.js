...
import { ${capitalize(moduleName)}Service } from '@app/${moduleName}/${moduleName}.service';

describe('${capitalize(moduleName)} Controller', () => {
  let controller: ${capitalize(moduleName)}Controller;

  beforeEach(() => {
    controller = new ${capitalize(moduleName)}Controller(new ${capitalize(moduleName)}Service());
  });
